...
const initialColumns: Column[] = [
  { id: 'open', title: 'Em Aberto', opportunities: [] },
  { id: 'won', title: 'Ganhas', opportunities: [] },
  { id: 'lost', title: 'Perdidas', opportunities: [] },
];
  ...
  const { isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const newColumns = initialColumns.map(col => ({
        ...col,
        opportunities: opportunities.filter(opp => opp.status === col.id)
      }));
