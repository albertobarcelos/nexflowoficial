...
export const TasksFilterBar: React.FC<TasksFilterBarProps> = ({
    ...
    <div className="flex items-center gap-3 overflow-x-auto bg-white px-0 md:px-0 pb-0 pt-0">
        <Filter className="w-4 h-4 text-slate-400 flex-shrink-0" />
        {showStatusFilter && (
            <div className="flex items-center gap-2 text-sm">
                <span className="text-slate-600 font-medium whitespace-nowrap">Status:</span>
